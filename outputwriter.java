...
class outputwriter extends EssayWriter {
	...
	static String parapoint1 = tpoint1.substring(0, 1).toLowerCase() + tpoint1.substring(1); 
	static String parapoint2 = tpoint2.substring(0, 1).toLowerCase() + tpoint2.substring(1);
	static String parapoint3 = tpoint3.substring(0, 1).toUpperCase() + tpoint3.substring(1);
	static int c;
